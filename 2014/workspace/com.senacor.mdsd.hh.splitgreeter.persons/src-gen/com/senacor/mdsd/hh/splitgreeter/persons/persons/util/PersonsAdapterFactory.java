/**
 */
package com.senacor.mdsd.hh.splitgreeter.persons.persons.util;
...
public class PersonsAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.senacor.mdsd.hh.splitgreeter.persons.persons.Model <em>Model</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.senacor.mdsd.hh.splitgreeter.persons.persons.Person <em>Person</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
