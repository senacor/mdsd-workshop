 ...
 * </p>
 * <ul>
 *   <li>{@link unihh.sample2.myDsl.impl.GreetingImpl#getWord <em>Word</em>}</li>
 *   <li>{@link unihh.sample2.myDsl.impl.GreetingImpl#getPerson <em>Person</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GreetingImpl extends MinimalEObjectImpl.Container implements Greeting
{
  ...
  public void setWord(Greetword newWord)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.GREETING__WORD, oldWord, word));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.GREETING__WORD:
        return getWord();
