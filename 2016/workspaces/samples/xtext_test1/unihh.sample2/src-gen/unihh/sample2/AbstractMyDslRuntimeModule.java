...
import unihh.sample2.generator.MyDslGenerator;
import unihh.sample2.parser.antlr.MyDslAntlrTokenFileProvider;
import unihh.sample2.parser.antlr.MyDslParser;
import unihh.sample2.parser.antlr.internal.InternalMyDslLexer;
import unihh.sample2.scoping.MyDslScopeProvider;
import unihh.sample2.serializer.MyDslSemanticSequencer;
import unihh.sample2.serializer.MyDslSyntacticSequencer;
import unihh.sample2.services.MyDslGrammarAccess;
import unihh.sample2.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "unihh/sample2/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("unihh.sample2.MyDsl");
	}
