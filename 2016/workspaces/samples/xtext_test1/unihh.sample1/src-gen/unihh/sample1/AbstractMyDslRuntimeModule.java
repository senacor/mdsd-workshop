...
import unihh.sample1.generator.MyDslGenerator;
import unihh.sample1.parser.antlr.MyDslAntlrTokenFileProvider;
import unihh.sample1.parser.antlr.MyDslParser;
import unihh.sample1.parser.antlr.internal.InternalMyDslLexer;
import unihh.sample1.scoping.MyDslScopeProvider;
import unihh.sample1.serializer.MyDslSemanticSequencer;
import unihh.sample1.serializer.MyDslSyntacticSequencer;
import unihh.sample1.services.MyDslGrammarAccess;
import unihh.sample1.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "unihh/sample1/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("unihh.sample1.MyDsl");
	}
